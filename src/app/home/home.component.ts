...
myarr:string[7];
  ...
  formanswer = new FormGroup({
    ...
    puzzle4: new FormControl('', [Validators.required, Validators.pattern('93846AQ')]),
    ...
    puzzle7: new FormControl('', [Validators.required, Validators.pattern('land')]),
    // 5614251
  })
  ...
  pickoption(o) {
    ...
    if (o == 0) {
      ...
      this.conversation = [];
      this.conversation = ["...", "Seventh way is through land ofcourse.", "*sarcastically* Im sorry, im not that advanced."]
